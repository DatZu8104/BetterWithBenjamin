...
import { Plus, Trash2, Folder, FolderOpen, MoreVertical, MoveRight, PlayCircle, RotateCcw, GraduationCap, Library, ChevronDown, Check, X, Settings, Pencil, Loader2, Volume2, BookOpen, ExternalLink, Calendar, Hash, ArrowDownAZ, Globe } from 'lucide-react';
            ...
            <div className="flex-1 w-full z-10">
              <div className="flex items-center gap-3 mb-2">
                <div className={cn("p-2 rounded-lg transition-colors", currentTheme.iconBox)}>
                   {currentFolder ? <Library className="w-6 h-6" /> : <Globe className="w-6 h-6" />}
                </div>
                
                <div className="flex items-center gap-3">
                    <h2 className={cn("text-2xl md:text-3xl font-bold transition-colors", currentTheme.title)}>
                    {currentFolder ? currentFolder : "System Master Library"}
                    </h2>
              ...
              <p className="text-zinc-400 mb-6 text-base max-w-xl">
                {currentFolder 
                    ...
                    : `Explore the complete system vocabulary collection of ${totalWords} words.`
                }
              </p>
