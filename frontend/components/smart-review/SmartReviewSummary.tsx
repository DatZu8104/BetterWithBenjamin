...
export function SmartReviewSummary({ results, onClose, onReviewAgain }: SmartReviewSummaryProps) {
    ...
    >
        ...
        <div className="flex flex-col items-center gap-3 p-5 border-b border-zinc-800 shrink-0">
        ...
        {/* Stats — scroll được, chiếm phần còn lại */}
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
            ...
            {/* Word list — không giới hạn chiều cao, để parent scroll */}
        ...
        {/* Footer — cố định dưới cùng, không co giãn */}
